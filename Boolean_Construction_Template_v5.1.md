...
**Version:** 5.0 · December 2025 · Sam Vangelos
            ...
            <section class="section expanded" id="archetypes">
                ...
                <div class="section-content">
                    <div class="subsection">
                        ...
                        <p>Each archetype represents a candidate profile. The <strong>Recipe</strong> shows which Boolean clusters combine to find them. The <strong>Why</strong> explains how these clusters work as signals.</p>
                        <p>Use archetypes as guidance, then scroll to <strong>Boolean Reference</strong> to copy the clusters you need and build your own search.</p>
                    </div>
...
<div class="archetype-item" onclick="toggleArchetype(this)">
    ...
    <div class="archetype-content">
        <div class="archetype-body">
            ...
            <div class="archetype-section">
                <div class="archetype-section-title">Why This Combination</div>
...
- [ ] 3-4 archetypes
- [ ] Section order: Summary → Archetypes → Boolean Reference → Footer
